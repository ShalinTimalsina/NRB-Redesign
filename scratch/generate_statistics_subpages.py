...
header_html = header_html.replace('href="../../pages/statistics/index.html"', 'href="../../../pages/statistics/index.html"')
header_html = header_html.replace('href="../../pages/statistics/', 'href="../../../pages/statistics/')
...
pages = [
    {'folder': 'macroeconomic', 'title': 'Macroeconomic Statistics', 'desc': 'Inflation, economic activity, surveys and macroeconomic indicators.'},
    {'folder': 'financial-sector', 'title': 'Financial Sector Statistics', 'desc': 'Banking, microfinance and financial sector performance data.'},
    {'folder': 'monetary-forex', 'title': 'Monetary & Forex Statistics', 'desc': 'Monetary operations, interest rates and foreign exchange information.'},
    {'folder': 'financial-inclusion', 'title': 'Financial Inclusion & Payments', 'desc': 'Financial inclusion indicators, payment systems and access metrics.'}
]

base_dir = 'c:/Users/LOQ/Desktop/NRB Redesign/pages/statistics'
        ...
        <div class="flex flex-col gap-3">
            <a class="hub-card nrb-elevated-card flex items-center justify-between p-5 bg-white border border-slate-200 rounded-[14px] hover:border-[#138496] group transition-colors" href="#" target="_blank">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <p class="font-semibold text-base text-slate-900 group-hover:text-[#138496] transition-colors leading-snug">Sample Statistical Report 1</p>
            ...
            <a class="hub-card nrb-elevated-card flex items-center justify-between p-5 bg-white border border-slate-200 rounded-[14px] hover:border-[#138496] group transition-colors" href="#" target="_blank">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <p class="font-semibold text-base text-slate-900 group-hover:text-[#138496] transition-colors leading-snug">Sample Statistical Report 2</p>
                        <div class="flex items-center text-[13px] text-slate-500"><span class="font-medium text-slate-700">EXCEL</span><span class="text-slate-300 px-1.5">•</span><span>2.1 MB</span><span class="text-slate-300 px-1.5">•</span><span>10 Aug 2026</span></div>
                    </div>
                </div>
                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-50 text-slate-400 group-hover:bg-[#138496] group-hover:text-white transition-colors ml-4"><svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" stroke-linecap="round" stroke-linejoin="round"></path></svg></div>
            </a>
            <a class="hub-card nrb-elevated-card flex items-center justify-between p-5 bg-white border border-slate-200 rounded-[14px] hover:border-[#138496] group transition-colors" href="#" target="_blank">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <p class="font-semibold text-base text-slate-900 group-hover:text-[#138496] transition-colors leading-snug">Sample Statistical Report 3</p>
...
<main>
    ...
    <section class="border-b border-slate-200 bg-white">
        <div class="nrb-section-shell py-10 lg:py-14">
            <nav aria-label="Breadcrumb" class="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">
                ...
                <a class="transition hover:text-[#25295B]" href="../index.html">Statistics</a>
                <span class="text-slate-300">/</span>
    ...
    <div class="sticky top-0 z-10 border-b border-slate-200 bg-white shadow-sm" id="Local-Navigation">
        <div class="nrb-section-shell">
            <nav aria-label="Statistics categories" class="nrb-page-nav flex items-center gap-8 py-4 overflow-x-auto">
                {active_nav.strip()}
            </nav>
        </div>
    </div>
...
"""
    ...
    full_html = re.sub(r'<title>.*?</title>', f'<title>{page["title"]} | Statistics | NRB</title>', full_html)
    
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(full_html)
        
print("Generated 4 subpages for Statistics.")
