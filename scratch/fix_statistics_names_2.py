...
<span class="block text-xs text-slate-400 font-normal mt-0.5 leading-relaxed">Live data of the exchanges.</span>
</a>
</div>
...
print(f"Updated {count} HTML files without separating the title.")
